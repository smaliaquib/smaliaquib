...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/aquib-k)
...
With 4.5+ years of experience spanning **data science, NLP, and AI engineering**, I design scalable, cost-efficient, and reliable ML/LLM pipelines that bridge research and production.
...
### [Ironclad](https://github.com/smaliaquib/ironclad) — AI  Application
  Built a **full-stack streaming chat application** with a **multi-service microservice architecture**, featuring a React + TypeScript frontend, Langraph, Go API gateway, and Python FastAPI agent backend powered by **Claude Haiku via AWS Bedrock**, connected end-to-end via **Server-Sent Events (SSE)** for real-time token streaming. Included **Dockerized local orchestration and Terraform-defined AWS ECS Fargate infrastructure** (per-service tasks, ALB routing, Cloud Map service discovery, per-branch CI/CD pipelines) for production deployment.
